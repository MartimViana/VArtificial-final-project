 ...
 */
public class MuECX extends Recombination {

    double EXPAND =1;

    @Override
    public Individual[] recombine(Individual... parents) {
        return executeECX((RealVector) parents[0], (RealVector) parents[1]);
    }
    
    
  public Individual[] executeECX(Individual ind1, Individual ind2) {
    ...
    public String getInformation() {
        ...
        buf.append(toString());
        buf.append("\nExtended Centroid Crossover ");
        buf.append("\nCalculates the centroid of the Individuals based on the number of copies");
        buf.append("\nExpand interval in both directions based in the number of copies");
