...
public class GeneticParameter extends javax.swing.JPanel {
    ...
    public List<Genetic> getAllElements() {
        ArrayList<Genetic> lst = new ArrayList<>();
        ArrayList<MuGAObject> array = MuGASystem.getGenetic(pathOfGenetic);
        for (MuGAObject muGAObject : array) {
            lst.add(muGAObject.obj);
        }
        return lst;
    }
