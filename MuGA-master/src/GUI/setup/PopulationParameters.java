...
public class PopulationParameters extends javax.swing.JPanel {
    ...
    public void setPopulation(Population pop, Individual ind) {
        myPopulation = pop.getCleanClone();
        myPopulation.createRandom(ind);

        spPopulationSize.setValue(pop.getMaximumSize());
    ...
    private void initComponents() {
        ...
        displayPop = new GUI.UIpopulation();
        ...
        rbSimplePopulation.setText("Simple Population");
        ...
        rbMultisetPopulation.setSelected(true);
        rbMultisetPopulation.setText("Multiset Population");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(displayPop, javax.swing.GroupLayout.DEFAULT_SIZE, 779, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(displayPop, javax.swing.GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE))
        );
    ...
    private void btCreatePopulationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCreatePopulationActionPerformed
        ...
        myPopulation.createRandom((Individual) selIndividual.genetic);
        myPopulation.evaluate();
        displayPop.setPopulation(myPopulation);
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
     ...
     * @param pop
     */
    public void FireEvent(Population pop) {
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
    ...
    private GUI.UIpopulation displayPop;
